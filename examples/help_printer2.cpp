...
int main(int argc, const char* argv[]) {
    ...
    runOptions->setGroupDescription("run group description");
    size_t dim;
    ...
    gatherOptions->setGroupDescription("gather group description");
    size_t gather_opt;
    ...
    commonOptions->setGroupDescription("common group description");
    size_t common_value;
