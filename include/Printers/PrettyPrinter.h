...
class PrettyPrinter : public DocumentVisitor {
   ...
   private:
    ...
    static std::string titlesuffix(size_t level) { return reset(); }
    static std::string textprefix(size_t level) { return repeat(level + 1, "  "); }
    static std::string textsuffix(size_t level) { return ""; }
