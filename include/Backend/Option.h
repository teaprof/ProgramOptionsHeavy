...
class AbstractOptionWithValue
{
  public:
    ...
    bool setValueRequired(bool value_required)
    {
        return value_required_ = value_required;
    }
    ...
    NValuesRole nValuesRole() const
    {
        return nvalues_role_;
    }
...
template <class T> class OptionWithValue
{
  public:
...
template <class T> class NamedOptionWithValue : public AbstractNamedOptionWithValue, public OptionWithValue<T>
{
  public:
    NamedOptionWithValue()
    {
    }
    NamedOptionWithValue(const std::string &undecorated_long_name)
        : AbstractNamedOptionWithValue(undecorated_long_name) {};
...
template <class T> class PositionalOptionWithValue : public AbstractPositionalOptionWithValue, public OptionWithValue<T>
{
  public:
    const BaseValueSemantics &baseValueSemantics() const override
    {
...
class OneOf : public AbstractOption
{
  public:
    ...
    OneOf(std::shared_ptr<AbstractOption> alt1, std::shared_ptr<AbstractOption> alt2,
          std::shared_ptr<AbstractOption> alt3);
...
inline NamedOption::NamedOption(const std::string &undecorated_long_name)
    : undecorated_long_name_{undecorated_long_name}
{
    sanitizeNames();
}
inline NamedOption::NamedOption(const std::string &undecorated_long_name, const std::string &undecorated_short_name)
    : AbstractOption(false), undecorated_long_name_{undecorated_long_name},
      undecorated_short_name_{undecorated_short_name}
{
    sanitizeNames();
}
...
inline std::string NamedOption::displayName() const
